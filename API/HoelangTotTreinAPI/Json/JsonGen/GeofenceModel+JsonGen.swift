...
extension GeofenceType {
  public static func decodeJson(_ json: Any) throws -> GeofenceType {
...
extension GeofenceModel {
  public static func decodeJson(_ json: Any) throws -> GeofenceModel {
...
extension GeofenceModels {
  public static func decodeJson(_ json: Any) throws -> GeofenceModels {
    let decoder = try JsonDecoder(json: json)
