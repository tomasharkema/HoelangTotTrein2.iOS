...
extension StationType {
  public static func decodeJson(_ json: Any) throws -> StationType {
...
extension Coords {
  public static func decodeJson(_ json: Any) throws -> Coords {
...
extension Station {
  public static func decodeJson(_ json: Any) throws -> Station {
    let decoder = try JsonDecoder(json: json)
...
extension StationsResponse {
  public static func decodeJson(_ json: Any) throws -> StationsResponse {
    let decoder = try JsonDecoder(json: json)
