...
//
//  Auto generated by swift-json-gen on Sun, 24 Jan 2016 17:05:53 GMT
...
extension GeofenceModel {
  static func decodeJson(json: AnyObject) throws -> GeofenceModel {
    ...
    if let station_field: AnyObject = dict["station"] {
      do {
        station_optional = try Station.decodeJson(station_field)
      }
      catch let error as JsonDecodeError {
      ...
      errors["station"] = JsonDecodeError.MissingField
    }
    ...
    return GeofenceModel(type: type, station: station, fromStop: fromStop, toStop: toStop)
  }
  ...
  func encodeJson() -> [String: AnyObject] {
    ...
    dict["station"] = station.encodeJson()
