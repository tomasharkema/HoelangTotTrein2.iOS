...
extension FareStatus {
  static func decodeJson(_ json: Any) throws -> FareStatus {
...
extension FareTime {
  static func decodeJson(_ json: Any) throws -> FareTime {
...
extension Melding {
  static func decodeJson(_ json: Any) throws -> Melding {
    let decoder = try JsonDecoder(json: json)
...
extension Stop {
  static func decodeJson(_ json: Any) throws -> Stop {
    let decoder = try JsonDecoder(json: json)
...
extension ReisDeel {
  static func decodeJson(_ json: Any) throws -> ReisDeel {
    let decoder = try JsonDecoder(json: json)
...
extension AdviceRequestCodes {
  static func decodeJson(_ json: Any) throws -> AdviceRequestCodes {
    let decoder = try JsonDecoder(json: json)
...
extension Advice {
  static func decodeJson(_ json: Any) throws -> Advice {
    let decoder = try JsonDecoder(json: json)
...
extension AdvicesResult {
  static func decodeJson(_ json: Any) throws -> AdvicesResult {
    let decoder = try JsonDecoder(json: json)
...
extension AdviceRequest {
  static func decodeJson(_ json: Any) throws -> AdviceRequest {
    let decoder = try JsonDecoder(json: json)
...
extension AdvicesAndRequest {
  static func decodeJson(_ json: Any) throws -> AdvicesAndRequest {
    let decoder = try JsonDecoder(json: json)
