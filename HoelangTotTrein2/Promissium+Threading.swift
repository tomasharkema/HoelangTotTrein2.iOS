...
//extension Request {
//
//  public func responseDecodePromise<T>(queue: dispatch_queue_t!, decoder: AnyObject -> T?) -> Promise<T, ErrorResponse<JsonDecodeResponseSerializerError>> {
//
...
//        }
//        else {
//          return Promise(error: ErrorResponse)
//        }
//    }
//  }
//
//  public func responseJSONPromise(queue: dispatch_queue_t!) -> Promise<AnyObject, ErrorResponse<JsonDecodeResponseSerializerError>> {
//    let source = PromiseSource<AnyObject, ErrorResponse<JsonDecodeResponseSerializerError>>()
//
